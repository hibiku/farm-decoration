"use strict";
(self["webpackChunkfarm_decoration"] = self["webpackChunkfarm_decoration"] || []).push([[216],{
...
/* harmony export */ });
/* unused harmony exports DEV, ErrorBoundary, Index, Match, Suspense, SuspenseList, Switch, awaitSuspense, cancelCallback, children, createComputed, createContext, createDeferred, createEffect, createResource, createSelector, createUniqueId, enableScheduling, equalFn, from, getOwner, indexArray, lazy, mapArray, mergeProps, observable, on, onCleanup, onError, requestCallback, runWithOwner, splitProps, startTransition, untrack, useContext, useTransition */
let taskIdCounter = 1,
...
function isWrappable(obj) {
  return obj != null && typeof obj === "object" && (obj[solid_js__WEBPACK_IMPORTED_MODULE_0__/* .$PROXY */ .bh] || !obj.__proto__ || obj.__proto__ === Object.prototype || Array.isArray(obj));
}
...
function proxyDescriptor(target, property) {
  ...
  if (!desc || desc.get || !desc.configurable || property === solid_js__WEBPACK_IMPORTED_MODULE_0__/* .$PROXY */ .bh || property === $NODE || property === $NAME) return desc;
  delete desc.value;
